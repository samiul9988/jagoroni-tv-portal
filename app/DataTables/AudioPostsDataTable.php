...
class AudioPostsDataTable extends DataTable
{
    /**
        ...
        return datatables()
            ...
            ->addColumn('action', function ($query) {
                ...
                if ( $currentUser->hasRole(['super-admin']) ) {
                    $action['del_url'] = route('audios.destroy', $query->id);
                    $action['edit_url'] = route('audios.edit', $query->id);
                }
    ...
    protected function getColumns(): array
    {
        return [
            Column::make('checkbox')
                ...
                ->titleAttr('')
                ->footer('<button type="button" name="bulk_delete" id="bulk_delete" class="btn btn btn-xs btn-danger" data-url="'.route('audios.mass.destroy').'">'.__('button.delete').'</button>')
