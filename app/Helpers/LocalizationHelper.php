...
Class LocalizationHelper
{
    ...
    public static function getCurrentLocaleId()
    {
        ...
        return (new class { use LanguageTrait; })->getLanguageIdByCode($currentLocale);
    }

    /**
     * @return Repository|Application|mixed|string
     */
    public static function getcurrentLocale(): mixed
    {
     ...
     * @return mixed
     */
    public static function languageWithFlag()
    {
        return Language::select('id', 'name', 'language', 'country', 'country_code')->whereActive('y')->get();
    }

    public static function getLangCodeActive()
    {
        return Language::select('language')->where('active', 'y')->get();
    }
    ...
    {
        $language = Language::select('language')->find($id);
    ...
    {
        return Language::firstWhere('language', config('settings.default_language'))->id;
    }
     ...
     * @return void
     */
    public static function getListFlags()
    {
