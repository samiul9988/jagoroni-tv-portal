...
@section('title', __('title.add_post_translation'))
...
@section('content_header')
    <x-breadcrumbs title="{{ __('title.add_post_translation') }}" currentActive="{{ __('title.translation') }}" :addLink="[__('title.posts') => route('posts.index')]"/>
@stop
                                    ...
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            ...
                                            @if(PostHelper::checkExistsTrans($trans->language, $post->translations->first()->value))
                                                <a class="btn btn-outline-secondary" href="{{ route('posts.edit', PostHelper::getTransPostId($trans->id, $post->translations->first()->value)) }}">
                                        ...
                                        <input type="text" class="form-control" placeholder="" aria-label="" aria-describedby="basic-addon1" value="{{ PostHelper::showTransPostTitle($trans->id, $post->translations->first()->value) }}" disabled>
                                    </div>
                                @endif
                            @endforeach
