            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header d-flex p-0">
                        <h3 class="card-title p-3">Videos</h3>
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-pane @if($post->post_type == 'video_url') active @endif" id="video_url">
                            <div class="form-group" id="url">
                                ...
                                @endphp
                                <input type="text" name="post_source" class="video_url form-control @error('post_source') is-invalid @enderror" placeholder="{{ __('form.placeholder_url') }}" value="{{ $value }}">
                                @error('post_source')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
